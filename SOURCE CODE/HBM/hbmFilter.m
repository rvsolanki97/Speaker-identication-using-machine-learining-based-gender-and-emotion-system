function [alpha, energy] = hbmFilter(x, model)
% HBM forward filtering algorithm. This is a wrapper function which transform input and call underlying algorithm
