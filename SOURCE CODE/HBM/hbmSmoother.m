function [gamma, alpha, beta, c] = hbmSmoother(x, model)
% HBM smoothing alogrithm (normalized forward-backward or normalized alpha-beta algorithm). This is a wrapper function which transform input and call underlying algorithm
...
M = E*X;
[gamma, alpha, beta, c] = hbmSmoother_(M, A, s);
